    ...
    <div class="">
        <div class="flex justify-center items-center min-h-screen bg-neutral-200">
            <div class="w-96 bg-white p-5 rounded-md flex-col flex gap-y-5 ">
                ...
                <form action="/register" method="POST" class="flex-col flex gap-y-5">
                    @csrf
                    ...
                    <button class="max-w-max bg-blue-500 text-white font-semibold px-2 py-3 rounded-md text-xs">Register
                        Now
                    </button>
                </form>
            </div>
